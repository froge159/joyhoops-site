        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-[#F5F7FA]">
          <div className="container px-4 md:px-6">
            <div className="mx-auto max-w-4xl">
              <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
                <div className="space-y-2">
                  <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-[#2E2E2E]">Send Us a Message</h2>
                  <p className="max-w-[600px] text-slate-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    Use this form to ask questions, request information, or express your interest in joining JoyHoops as
                    a volunteer, participant, or supporter.
                  </p>
                </div>
              </div>
                ...
                <CardHeader className="pb-8">
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label htmlFor="name" className="text-sm font-medium text-[#2E2E2E]">
                          Full Name *
                        </label>
                        <input
                          type="text"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        <label htmlFor="interest" className="text-sm font-medium text-[#2E2E2E]">
                          I'm Interested In
                        </label>
                        <select
                          id="interest"
                        ...
                        >
                          ...
                          <option value="participant">Enrolling My Child</option>
                    ...
                    <div className="space-y-2">
                      <label htmlFor="subject" className="text-sm font-medium text-[#2E2E2E]">
                        Subject *
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="message" className="text-sm font-medium text-[#2E2E2E]">
                        Message *
                      </label>
                      <textarea
                        id="message"
                        ...
                        rows={6}
                        className="w-full px-3 py-2 border border-slate-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#3DA9FC] focus:border-[#3DA9FC]"
                        placeholder="Tell us about your interest in JoyHoops, any questions you have, or how you'd like to get involved..."
                      />
                    </div>

                    <div className="bg-[#F5F7FA] p-4 rounded-lg">
                      <p className="text-sm text-slate-600 mb-2">
                        <strong>Want to join our organization?</strong> Use this form to express your interest! Whether
                        you want to:
                      </p>
                      <ul className="text-sm text-slate-600 space-y-1 ml-4">
                        <li>• Volunteer as a student coach or mentor</li>
                        <li>• Enroll your child in our programs</li>
                        <li>• Partner with us as a school or community organization</li>
                        <li>• Support us through donations or sponsorship</li>
                      </ul>
                      <p className="text-sm text-slate-600 mt-2">
                        We'll get back to you with next steps and answer any questions you have!
                      </p>
                    </div>
            ...
            <div className="mx-auto grid max-w-6xl items-center gap-12 py-12 lg:grid-cols-2 lg:gap-16">
              <div className="space-y-8">
                <div className="space-y-4">
                  <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-[#2E2E2E]">Visit Our Office</h2>
                  <p className="text-slate-600 md:text-lg/relaxed">
                    Our main office is open for in-person visits, meetings, and program registration. We're located in
                    the heart of the community we serve.
                  </p>
                </div>

                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <div className="h-10 w-10 bg-[#3DA9FC] rounded-full flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="h-10 w-10 bg-[#FF6B35] rounded-full flex items-center justify-center flex-shrink-0">
                      <Phone className="h-5 w-5 text-white" />
                    </div>
                    <div>
                      <h3 className="font-semibold text-[#2E2E2E] mb-1">Office Hours</h3>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#2E2E2E] mb-1">WeChat QR Code</h3>
                      <p className="text-slate-600 mb-3">
                        Scan to connect with us on WeChat for quick communication and updates about programs and events.
                      </p>
              ...
              <div className="relative">
                <Image
                  ...
                  width="600"
                  height="500"
                  alt="JoyHoops office and community center"

    ...
    if (newClass.name && newClass.startDatetime && newClass.endDatetime && newClass.location) {
      ...
      const response = await fetch("/api/create-class", {
        ...
        body: JSON.stringify({
          ...
          startDatetime: new Date(classItem.startDatetime).toISOString(),
          endDatetime: new Date(classItem.endDatetime).toISOString(),
    ...
    if (editingClass) {
      const response = await fetch("/api/update-class", {
        ...
        body: JSON.stringify({
          ...
          startDatetime: new Date(editingClass.startDatetime).toISOString(),
          endDatetime: new Date(editingClass.endDatetime).toISOString(),
